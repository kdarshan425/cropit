...
<body>
    <?php include 'partials/header.php';
     ...
     <div style="width:100%;height:auto;background: url(img/bg.jpg);padding-top:70px;">
        ...
        <center><h1 style="color:white;font-family: 'Raleway', sans-serif;">Consumer </h1></center>
        </div>    
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $resident_name = str_replace("<", "&lt;", $resident_name);
        $resident_name = str_replace(">", "&gt;", $resident_name);
        $resident_name = str_replace("'", "\\'", $resident_name);
        ...
        $current_problems = str_replace("<", "&lt;", $current_problems);
        $current_problems = str_replace(">", "&gt;", $current_problems); 
        $current_problems = str_replace("'", "\\'", $current_problems);
        ...
        $sql1 =  "INSERT INTO `consumers` (`id`, `name`, `city`, `state`, `country`, `contact`, `resident_name`, `crop_requirment`, `current_problems`, `timestamp`) VALUES (NULL, '$Name', '$City', '$State', '$Country', '$contact', '$resident_name', '$crop_requirment', '$current_problems', CURRENT_TIMESTAMP);";
    ...
    <div class="container">
            ...
            <form method="post" action="<?php $_SERVER["REQUEST_URI"]?>" enctype="multipart/form-data"> 
                ...
                <div class="mb-3">                    
                    <label style="font-size:1.3rcm;font-weight:bold;" for="validationTextarea" class="form-label lebel1">humedity</label>
                    <div class="input-group flex-nowrap">                
                        <input name="humedity" type="text" class="form-control" placeholder="Enter value of humedity" aria-describedby="inputGroup-sizing-lg" aria-label="Challengename" aria-describedby="addon-wrapping" required>
                    </div>                
                </div>   
                <div class="mb-3">
