...
<head>
    ...
    <title>Cropit | Business record</title>
...
<body>
    ...
    $method = $_SERVER['REQUEST_METHOD'];
        ...
        $sql2 = "DELETE FROM `business` WHERE `id`=$res_id;";
        $result1 = mysqli_query($conn, $sql2); 
        if($result1){
            header("Location: business_records.php?response_deleted=true"); 
        }
        else{
            echo'Error occured!';
        }
    ...
    <div class="challenges container my-4"  style="padding-bottom:70px;">
