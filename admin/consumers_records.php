...
<body>
    ...
    <div style="padding-top:70px;">
        ...
        <center>
        <h1 style="font-family: 'Raleway', sans-serif;">Consumer records!</h1>
        </center>       
        </div>
    </div>
    ...
    <div class="challenges container my-4">
        ...
        $sql = "SELECT * FROM `consumers` ORDER BY `timestamp` DESC ";
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4 my-3">
                    <div class="card" style="padding:0px;box-shadow: 0px 10px 20px -5px rgb(73 93 207 / 20%);">              
                        <div class="card-body chal-card-body" style="align-item:center; padding: 2.15rem;">
                            ...
                            <div class="chall-but"><a href="consumer_records_expand.php?id='. $id .' " style="background:#2e6e56db;" class="btn btn-primary">View</a></div>
                        </div>
                    </div>
                </div>';
            }      
